# MGraph AI Service Deploy

[![Current Release](https://img.shields.io/badge/release-v0.6.0-blue)](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Deploy/releases)
...
[![CI Pipeline - DEV](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Deploy/actions/workflows/ci-pipeline__dev.yml/badge.svg)](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Deploy/actions)
...
To create a new service from this template, see [Creating Services from MGraph-AI__Service__Deploy](docs/dev/non-functional-requirements/version-1_0_0/README.md).
...
# or
uvicorn mgraph_ai_service_deploy.fast_api.lambda_handler:app --reload --host 0.0.0.0 --port 10011
```
...
# Run with coverage
pytest --cov=mgraph_ai_service_deploy
...
- 🐛 Issues: [GitHub Issues](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Deploy/issues)
- 💬 Discussions: [GitHub Discussions](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Deploy/discussions)
