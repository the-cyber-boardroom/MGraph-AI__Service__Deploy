...
from mgraph_ai_service_deploy.schemas.common.Safe_Str__GitHub__Secret_Name import Safe_Str__GitHub__Secret_Name
...
class Schema__Request__GitHub__Secrets__Create(Type_Safe):
    ...
    secret_name     : Safe_Str__GitHub__Secret_Name                         # Name of secret to create/update
    encrypted_value : Safe_Str__Encrypted__Base64                           # Client-encrypted secret value
