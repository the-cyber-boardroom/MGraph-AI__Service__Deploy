...
from tests.unit.Deploy__Service__Fast_API__Test_Objs  import setup__deploy_service__fast_api_test_objs, TEST_API_KEY__NAME, TEST_API_KEY__VALUE


class test_Routes__Info__client(TestCase):
    @classmethod
    def setUpClass(cls):
        with setup__deploy_service__fast_api_test_objs() as _:
